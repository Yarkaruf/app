...
import styles from "modules/common/components/vds-banner/vds-banner.module.scss";
...
export const VdsBanner = (props: IAdvantageBanner) => {
  return (
      ...
      <Container>
        <div className={styles.inner}>
          <div className={cx(styles.card, props.appearance === "right" && styles.right)}>
            ...
            {props.textAfter && (
              <Paragraph level={1} className={styles.text_after}>
                {props.textAfter}
              </Paragraph>
            )}
